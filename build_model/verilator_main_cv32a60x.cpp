...
int main(int argc, char **argv) {
    ...
    while (true) {
        ...
        //Update read interface TODO - Unknown simulation error with cv32a60x if load_req = (top->mem_req_o && !top->mem_we_o).  Original Vicuna also did not contain this condition

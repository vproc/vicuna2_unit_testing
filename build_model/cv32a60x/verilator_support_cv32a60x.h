...
#ifndef VERILATOR_SUPPORT_H
#define VERILATOR_SUPPORT_H
...
/*
* Functions and Variables used to detect a stall.  Returns true if IF_PC in CV32E40X core has not changed in the provided number of cycles  TODO:CVA6 Variant
* ARGS:
...
*/
bool check_PC(Vvproc_top *top, uint32_t address); //TODO:CVA6 Variant
...
*   *mem           - pointer to memory space
*/
void update_mem_write(Vvproc_top *top, uint32_t address, bool req_valid, bool req_src, uint32_t mem_w, uint32_t mem_lat, uint32_t mem_size, unsigned char *model_data_o, unsigned char *model_be_o, bool *mem_w_valid_i, bool *queue_valid, bool **queue_meta, unsigned char *mem);
...
*   - end_cycles    - cycle count to end trace
*/
void update_inst_trace(Vvproc_top *top, FILE *inst_trace, uint32_t begin_cycles, uint32_t end_cycles);  //TODO:CVA6 Variant
...
*/
void update_xreg_commit(Vvproc_top *top, FILE *commit_log); //TODO:CVA6 Variant
...
*   - *commit_log   - pointer to .txt trace file output
*/
void update_freg_commit(Vvproc_top *top, FILE *commit_log); //TODO:CVA6 Variant
